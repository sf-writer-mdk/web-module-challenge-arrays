...
function copy(arr) {
  let arrCopy = [] // creating a new array
  arrCopy = arr.slice() // a shallow copy of 'orginalFlavors'
  //console.log(arrCopy)
  return arrCopy
}
...
addFlavor(originalFlavors, 'Loving Lime')
...
function getFlavorByIndex(flavor, idx) {
  return flavor[idx]
}
